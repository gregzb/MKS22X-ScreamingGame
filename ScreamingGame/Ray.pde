public class Ray {
  ...
  public RaycastInfo raycast(Ray r) {
    ...
    if (denom == 0) {
      return new RaycastInfo(false, null, this, r, -1);
    } else {
      ...
      if (tA >= 0 && tA <= 1 && tB >= 0 && tB<= 1){
        return new RaycastInfo(true, PVector.add(p1, PVector.mult(PVector.add(p2, PVector.mult(p1, -1)), tA)), this, r, tA);
      } else {
        return new RaycastInfo(false, PVector.add(p1, PVector.mult(PVector.add(p2, PVector.mult(p1, -1)), tA)), this, r, tA);
      }
    }
  }
